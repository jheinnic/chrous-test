...
import {fromTranscript, fromVideoItem, fromVideoMeta, fromWorkbench} from './store';
...
@NgModule({
  declarations: [
    PageContainerComponent, TranscriptDialogComponent, TiledPageContainerComponent,
    LinkedPageContainerComponent
  ],
  imports: [
    SharedModule,
    CommonModule,
